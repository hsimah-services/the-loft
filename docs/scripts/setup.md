...
| 5 | Users — `littledog` (UID 1003, nologin service account), `adminhabl` (sudo admin), `hsimah` (SSH), `rodnik` (i3 display account, i3 hosts) | `LITTLEDOG_EXTRA_GROUPS`, `I3_ENABLED` |
